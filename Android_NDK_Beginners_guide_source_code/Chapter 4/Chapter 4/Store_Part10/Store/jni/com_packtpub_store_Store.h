 ...
 * Class:     com_packtpub_store_Store
 * Method:    getColor
 * Signature: (Ljava/lang/String;)Lcom/packtpub/store/Color;
 */
 ...
 * Class:     com_packtpub_store_Store
 * Method:    setColor
 * Signature: (Ljava/lang/String;Lcom/packtpub/store/Color;)V
 */
 ...
 * Signature: (Ljava/lang/String;)[Z
 */
JNIEXPORT jbooleanArray JNICALL Java_com_packtpub_store_Store_getBooleanArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_packtpub_store_Store_getByteArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_com_packtpub_store_Store_getDoubleArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[F
 */
JNIEXPORT jfloatArray JNICALL Java_com_packtpub_store_Store_getFloatArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[I
 */
JNIEXPORT jintArray JNICALL Java_com_packtpub_store_Store_getIntegerArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[J
 */
JNIEXPORT jlongArray JNICALL Java_com_packtpub_store_Store_getLongArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[S
 */
JNIEXPORT jshortArray JNICALL Java_com_packtpub_store_Store_getShortArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[Ljava/lang/String;
 */
JNIEXPORT jobjectArray JNICALL Java_com_packtpub_store_Store_getStringArray
  (JNIEnv *, jobject, jstring);
 ...
 * Signature: (Ljava/lang/String;)[Lcom/packtpub/store/Color;
 */
JNIEXPORT jobjectArray JNICALL Java_com_packtpub_store_Store_getColorArray
  (JNIEnv *, jobject, jstring);
